...
const Navbar = () => {
  ...
  return (
    <>
      ...
      {/* Mobile navigation */}
      <div className={`fixed top-0 left-0 w-3/4 sm:w-3/4 md:w-1/3 h-full bg-white shadow-lg transform transition-transform duration-300 z-50 ${navDrawerOpen ? 'translate-x-0' : '-translate-x-full'}`}>
